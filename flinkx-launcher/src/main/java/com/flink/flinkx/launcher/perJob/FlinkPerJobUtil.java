...
import com.flink.flinkx.util.ValueUtil;
...
import static com.flink.flinkx.constants.ConfigConstant.YARN_RESOURCE_MANAGER_WEBAPP_ADDRESS_KEY;
...
public class FlinkPerJobUtil {
    private static final Logger LOG = LoggerFactory.getLogger(com.flink.flinkx.launcher.perJob.FlinkPerJobUtil.class);
    /**
